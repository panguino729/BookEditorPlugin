...
class BookEditorPlugin(InterfaceActionBase):
    '''
    ...
    '''
    name                = 'Book Editor Plugin'
    description         = 'A Book Editor Plugin'
    supported_platforms = ['windows', 'osx', 'linux']
    author              = 'Katarina Tretter'
    version             = (1, 0, 0)
    ...
    def config_widget(self):
        ...
        from calibre_plugins.book_editor.config import ConfigWidget
        return ConfigWidget()
